...
def parse_args():
    ...
    parser.add_argument('--batch_size', default=8, type=int, help='训练批大小')
    ...
    parser.add_argument('--checkpoint_base_dir', default='/home/k/Projects/equi/IsaacLab/scripts/workspace/train/results', type=str, help='检查点根目录（将自动生成子目录名）')
    ...
    parser.add_argument('--model_path', default='/home/k/Projects/equi/IsaacLab/scripts/workspace/train/results/equi_obj_7/model_final.pth', type=str, help='预训练模型路径')
