...
class SAMWrapper:
    def __init__(self, checkpoint_path="/home/k/Projects/equi/IsaacLab/scripts/workspace/sam_model/sam_vit_h_4b8939.pth", model_type="vit_h", device="cuda"):
        self.device = device
...
if __name__ == "__main__":
    # Load image
    image = cv2.imread('/home/k/Projects/equi/IsaacLab/scripts/workspace/src/image.png')
