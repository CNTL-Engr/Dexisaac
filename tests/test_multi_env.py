...
import sys
sys.path.insert(0, "/home/k/Projects/equi/IsaacLab/scripts/workspace/src")
    ...
    while frame_count < max_frames:
        ...
        if frame_count == 50 and not captured:
            ...
            for env_idx, state in enumerate(scene.states):
                ...
                save_path = f"/home/k/Projects/equi/IsaacLab/scripts/workspace/test_imgs/Scene_{env_idx}"
