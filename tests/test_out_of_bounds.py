...
def test_out_of_bounds_detection():
    ...
    for env_idx in range(scene.num_envs):
        ...
        if raw_mask is not None:
            ...
            # 保存掩膜图像
            save_path = f"/home/k/Projects/equi/IsaacLab/scripts/workspace/test_imgs/raw_mask_env_{env_idx}.png"
        ...
        if raw_mask is not None:
            ...
            # 保存可视化
            vis_path = f"/home/k/Projects/equi/IsaacLab/scripts/workspace/test_imgs/vis_mask_env_{env_idx}.png"
